  ...
  <form action="{{route('admissions.store')}}" method="POST">
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="patient_id" class="form-control" id=""  value="{{$patients->id}}" placeholder="Patient ID" required>
      </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <select name="supervisor_id" class="custom-select rounded-0" id="supervisor_id" required>
                <option value="-1" selected disabled>--Select One--</option>
          ...
          <div class="form-group">
              ...
              <input type="text" name="total_paid" class="form-control" id="total_paid" placeholder="Enter Total Paid Amount" required>
          </div>
          <div class="form-group">
            <label for="paid_method">Paid Method</label>
            <input type="text" name="paid_method" class="form-control" id="paid_method" placeholder="Paid Method" required>
          </div> 
          ...
          <div class="form-group">
            ...
            <select name="admitted_by" class="custom-select rounded-0" id="admitted_by" required>
              <option value="-1" selected disabled>--Select One--</option>
